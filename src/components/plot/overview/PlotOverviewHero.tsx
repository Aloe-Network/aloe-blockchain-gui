...
import { CardHero, Link } from '@aloe/core';
import { PlotHero as PlotHeroIcon } from '@aloe/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {'Plots are allocated space on your hard drive used to farm and earn Aloe. '}
              <Link target="_blank" href="https://github.com/Aloe-Network/aloe-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button
