...
import icon from '../../assets/img/aloe_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <BugReport href="https://github.com/Aloe-Network/aloe-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
