...
import { AlertDialog, Flex, Card } from '@aloe/core';
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of aloe in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Aloe that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Aloe that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send aloe to coloured address. Please enter a aloe
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'aloe_addr://') {
